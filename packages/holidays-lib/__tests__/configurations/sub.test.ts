...
describe('valid with 3 levels', () => {
  ...
  test('parent > number of holidays', () => expect(configuration.holidayCollection.length).toBe(1));
  ...
  test('child1 > number of holidays', () => expect(child1.holidayCollection.length).toBe(1));
  const holiday1 = child1.holidayCollection[0] as IFixedDateHoliday;
  ...
  test('child2 > number of holidays', () => expect(child2.holidayCollection.length).toBe(1));
  const holiday2 = child2.holidayCollection[0] as IFixedDateHoliday;
  ...
  test('grandChild > number of holidays', () => expect(grandChild.holidayCollection.length).toBe(1));
  const holiday3 = grandChild.holidayCollection[0] as IFixedDateHoliday;
